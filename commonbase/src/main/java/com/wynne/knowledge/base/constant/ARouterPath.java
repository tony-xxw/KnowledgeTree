...
public class ARouterPath {
    ...
    public static final String BASE_HIGH = "/high/home";
    public static final String BASE_HIGH_AROUTER = "/high/arouter";
    ...
    public static final String PROVIDER="/provider/advance";
    public static final String INTERCEPTOR="arouter";
}
