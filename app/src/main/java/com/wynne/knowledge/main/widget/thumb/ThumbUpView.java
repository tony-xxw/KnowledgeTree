...
import com.wynne.knowledge.main.Utils;
...
public class ThumbUpView extends LinearLayout implements View.OnClickListener {
    ...
    public ThumbUpView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mDrawablePadding = typedAttrs.getDimension(R.styleable.ThumbUpView_tuv_drawable_padding, Utils.dip2px(context, DEFAULT_DRAWABLE_PADDING));
        ...
        mTextSize = typedAttrs.getDimension(R.styleable.ThumbUpView_tuv_text_size, Utils.dip2px(context, CountView.DEFAULT_TEXT_SIZE));
